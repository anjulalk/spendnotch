...
Stack: Electron 44, Vite 8, React 19, TypeScript 7, Tailwind CSS 4, Motion and NumberFlow. It uses Node's built-in `node:sqlite`, so there are no native modules.
